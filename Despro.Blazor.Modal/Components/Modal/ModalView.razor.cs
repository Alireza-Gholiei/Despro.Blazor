...
{
    public partial class ModalView : BaseComponent, IDisposable
    {

        [Inject] protected BaseService BaseService { get; set; }
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (!isInitialized)
            {
                ...
                {
                    await BaseService.SetElementProperty(dragContainer, "draggable", true);
                    await BaseService.DisableDraggable(dragContainer, contentContainer);
                }
                isInitialized = true;
            }
        }
