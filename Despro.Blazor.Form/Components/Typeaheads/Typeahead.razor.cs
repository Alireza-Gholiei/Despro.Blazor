...
namespace Despro.Blazor.Form.Components.Typeaheads;

public partial class Typeahead<TItem, TValue> : BaseComponent
{
    ...
    {
        return SelectedValue == null ? false : SelectedValue.Equals(ConvertExpression(item));
    }
