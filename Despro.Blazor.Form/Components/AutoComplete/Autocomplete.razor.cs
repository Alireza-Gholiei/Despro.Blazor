...
namespace Despro.Blazor.Form.Components.AutoComplete;

public partial class Autocomplete<TItem> : BaseComponent, IDisposable
{
    ...
    private async Task DoSearch()
    {
        ...
        IsShowingSuggestions = NotFoundTemplate != null ? true : Result?.Any() == true || GroupedResult?.Any() == true;
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        ...
        {
            await BaseService.PreventDefaultKey(_searchInput, "keydown", new[] { "Enter" });
    ...
    private string GetSearchText(string value)
    {
        ...
        string[] splitString = value.Split(SeparatorCharacter);
        return splitString.Any() ? splitString[^1].Trim() : string.Empty;
    }
}