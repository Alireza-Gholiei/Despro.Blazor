...
{
    public partial class ItemSelect<TItem, TValue> : BaseComponent, IDisposable
    {
        /// <summary>
        /// List of items 
        /// </summary>
        ...
        protected override void OnParametersSet()
        {
            ...
            if (MultiSelect && SelectedValues != null)
            {
                ...
                {
                    foreach (TValue selectedValue in SelectedValues)
                    {
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            {
                userAgent = await jSRuntime.InvokeAsync<string>("Framework.View.getUserAgent");
            }
        }
        ...
        {
            _ = OnExpanded.InvokeAsync(expanded);
        }
        ...
        private string GetListStyle()
        {
            ...
            {
                string overFlowStyle = isFirefoxBrowser ? "overflow-y:scroll;" : "overflow-y:overlay;";
        ...
        {
            TItem item = Items.FirstOrDefault(e => EqualityComparer<TValue>.Default.Equals(ConvertExpression(e), value));
            if (item != null)
            {
        ...
        {
            List<TItem> myList = FilteredList();
            ...
            {
                int pos = myList.IndexOf(highlighted);
                pos += step;
        ...
        {
            return SelectedTextExpression == null ? item.ToString() : SelectedTextExpression.Invoke(item);
        }
        ...
        private bool IsHighlighted(TItem item)
        {
            return highlighted == null
                ? false
                : IdExpression != null ? IdExpression.Invoke(highlighted) == IdExpression.Invoke(item) : highlighted.Equals(item);
        }

        private bool IsSelected(TItem item)
        {
            return IdExpression != null
                ? selectedItems.FirstOrDefault(e => IdExpression.Invoke(e) == IdExpression.Invoke(item)) != null
